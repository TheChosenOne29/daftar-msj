...
<div class="row align-items-md-stretch">
    <div class="col">
        <div class="h-100 p-5 bg-light border rounded-3">
            ...
            <button class="btn btn-primary" type="button">Daftar MSJ 1</button>
        </div>
    </div>
    <div class="col">
        <div class="h-100 p-5 bg-light border rounded-3">
            ...
            <button class="btn btn-primary" type="button">Daftar MSJ 2</button>
        </div>
    </div>
    <div class="col">
        <div class="h-100 p-5 bg-light border rounded-3">
            ...
            <button class="btn btn-primary" type="button">Daftar MSJ 3</button>
        </div>
    </div>
</div>
@endsection